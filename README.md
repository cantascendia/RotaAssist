...
[![Version](https://img.shields.io/badge/version-1.1.1--rc.7-orange)](docs/QUALITY_BASELINE.md)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

**RotaAssist** — WoW Midnight 12.1 的循环**教练**插件。
*A rotation **coach** for WoW Midnight 12.1 — not another "next spell" icon.*

> **当前交付：1.1.1-rc.7 本地安装候选包。** 已接入公开事实、可能状态的一致决策和可选独立首位，
...
详见 [rc.7 说明](docs/RELEASE_1.1.1-rc.7.md)。
...
### Manual / 手动安装
1. 获取本次交付的 `RotaAssist-1.1.1-rc.7.zip`；源码 ZIP 不能替代带依赖的安装包
2. 解压到
